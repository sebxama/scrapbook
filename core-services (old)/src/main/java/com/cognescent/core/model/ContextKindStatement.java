...
public class ContextKindStatement extends KindStatement<StatementContext, StatementSubject, StatementObject> {
	...
	public ContextKindStatement(Statement stat, Kind<StatementContext, StatementSubject, StatementObject> kind, StatementContext instance, StatementSubject attribute, StatementObject value) {
