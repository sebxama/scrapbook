...
public class SubjectKindStatement extends KindStatement<StatementSubject, StatementPredicate, StatementObject> {
	...
	public SubjectKindStatement(Statement stat, Kind<StatementSubject, StatementPredicate, StatementObject> kind, StatementSubject instance, StatementPredicate attribute, StatementObject value) {
